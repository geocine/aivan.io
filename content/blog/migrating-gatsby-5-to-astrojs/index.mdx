...
Remote or legacy post images can still go through Cloudflare transformations, but generated covers should live in the separate assets repository and load through `https://cdn.aivan.io`.
